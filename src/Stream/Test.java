...
public class Test {
    public static void main(String[] args) {
        ...
        Person janusz = new Person("anusz", 36, Collections.singletonList(brajan), new Adres("96-124", "Makówu", "Kasztanowa 1"));
        Person dariusz = new Person("Dariusz", 39, Collections.singletonList(dzesika), new Adres("96-100", "Skierniewice", "Tuwima 3"));
        Person grazyna = new Person("Grazyna", 31, Arrays.asList(dzesika, brajan), new Adres("96-124", "Makówo", "Kasztanowa 1"));
